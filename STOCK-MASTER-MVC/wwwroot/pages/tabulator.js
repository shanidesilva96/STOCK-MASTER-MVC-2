document.addEventListener( "DOMContentLoaded", () => {
   ...
   const paginationTable = new Tabulator("#_dm-tabulatorPagination", {
      ...
      columns:[
         {title:"User Id", field:"name", sorter:"string" },
         {title:"First Name", field:"age", sorter:"number" },
         {title:"Middle Name", field:"gender", sorter:"string" },
         {title:"Last name", field:"col", sorter:"string" },
         {title:"Date Of Birth", field:"col", sorter:"string" }
      ],
   });
